...
public class ThirdActivity extends AppCompatActivity {
    ...
    private void initialize_Visualization() {
        ...
        graph.getVertex().add(new Vertex(v1, ContextCompat.getDrawable(this, R.drawable.png)));
        graph.getVertex().add(new Vertex(v2, ContextCompat.getDrawable(this, R.drawable.png)));
        graph.addEdge(new SimpleEdge(v1, v2, "12"));

        Node v3 = new SimpleNode("7");
        graph.getVertex().add(new Vertex(v3, ContextCompat.getDrawable(this, R.drawable.png)));
